...
The raw data file can be found in the tweet_input folder. The script in src/average_degree.py is run and the output is saved in tweet_output folder. The parse library is used to read the datetime from the raw file.
